...
async function requireAuth(req, res, next) {
  try {
    ...
    // File-download links (Excel exports) can't set an Authorization header when
    // opened directly in a browser, so those routes may also pass ?token=... — every
    // other route should keep using the header.
