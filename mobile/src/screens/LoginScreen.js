...
export default function LoginScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Megha Association</Text>
      ...
      <TouchableOpacity onPress={() => navigation.navigate("DriverSignup")}>
        <Text style={styles.signupLink}>New driver? Create an account</Text>
      </TouchableOpacity>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  signupLink: { color: "#666", textAlign: "center", marginTop: 22, fontWeight: "600" },
});
