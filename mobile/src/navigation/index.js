...
import AdminDriverDetailScreen from "../screens/admin/DriverDetailScreen";
...
import EditSalaryScreen from "../screens/admin/EditSalaryScreen";
...
function AdminDriversStackNavigator() {
  return (
    <AdminDriversStack.Navigator>
      ...
      <AdminDriversStack.Screen name="DriverDetail" component={AdminDriverDetailScreen} options={{ title: "Driver Details" }} />
    </AdminDriversStack.Navigator>
  );
}
...
function AdminSalaryStackNavigator() {
  return (
    <AdminSalaryStack.Navigator>
      ...
      <AdminSalaryStack.Screen name="EditSalary" component={EditSalaryScreen} options={{ title: "Edit Salary Amount" }} />
...
function AdminNavigator() {
  return (
    <AdminTabs.Navigator screenOptions={{ headerShown: false }}>
      ...
      <AdminTabs.Screen name="Attendance" component={AdminAttendanceScreen} options={{ headerShown: true, title: "Attendance" }} />
      ...
      <RootStack.Navigator screenOptions={{ headerShown: false }}>
        {!user ? (
          <>
            ...
            <RootStack.Screen name="ForgotPassword" component={ForgotPasswordScreen} options={{ headerShown: true, title: "Reset Password" }} />
          </>
        ) : user.role === "ADMIN" ? (
          <>
